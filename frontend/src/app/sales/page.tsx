...
import { Plus, Search, Receipt, User, Calendar, DollarSign, Trash2, Loader2, Minus, PlusCircle } from "lucide-react";
                                ...
                                {invoices.length === 0 ? (
                                    ...
                                    invoices.map((inv) => (
                                        <TableRow key={inv.id}>
                                            ...
                                            <TableCell className="font-bold">${inv.final_amount}</TableCell>
                                            <TableCell className="text-green-600">${inv.paid_amount}</TableCell>
                                            <TableCell className="text-rose-600">${inv.due_amount}</TableCell>
                                            <TableCell>
            ...
            <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        ...
                        <DialogDescription>Fill in customer details and add products.</DialogDescription>
                    </DialogHeader>
                    <form onSubmit={handleCreateInvoice} className="space-y-6 py-4">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div className="bg-muted p-6 rounded-xl flex flex-col justify-center space-y-4">
                                <div className="flex justify-between items-center">
                                ...
                                <div className="border-t border-border pt-4 flex justify-between items-center text-xl">
                                    ...
                                    <span className="font-black text-primary">${calculateTotal().toFixed(2)}</span>
                                </div>
                        ...
                        <DialogFooter>
                            <Button type="submit" className="w-full h-12 text-lg">Create & Print Invoice</Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
            </Dialog>
